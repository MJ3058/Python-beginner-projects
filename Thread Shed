...
for clean in daily_transactions_split:
  transactions_clean2 = []
  for clean2 in clean:
    transactions_clean2.append(clean2.replace("\n", "").strip(" "))
...
for trs in transactions_clean:
  customers.append(trs[0])
  sales.append(trs[1])
  thread_sold.append(trs[2])
...
for color in colors:
  print("Theard Shed sold {0} threads of {1} thread today".format(color_count(color), color))
